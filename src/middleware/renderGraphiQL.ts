...
export interface IGraphiQLData {
    query?: any;
    variables?: any;
    operationName?: any;
    result?: any;
   ...
   * requested query.
   */
  export function renderGraphiQL(data: IGraphiQLData): string {
  ...
  <head>
    ...
    <link href="//cdn.bootcss.com/graphiql/${GRAPHIQL_VERSION}/graphiql.css" rel="stylesheet" />
    ...
    <script src="//cdn.bootcss.com/graphiql/${GRAPHIQL_VERSION}/graphiql.min.js"></script>
  </head>
  <body>
    <script>
